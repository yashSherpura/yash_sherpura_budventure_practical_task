...
class UpcomingWidget extends StatelessWidget {
  const UpcomingWidget({super.key, required this.upComingResultList});

  final List<ResultModel> upComingResultList;

  @override
  Widget build(BuildContext context) {
    return SizedBox(
      height: MediaQuery.of(context).size.height * .20,
      child: upComingResultList.isEmpty
          ? const Center(
              child: TextLabel(
          ...
          : ListView.builder(
              itemCount: upComingResultList.length,
                  ...
                  child: SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                            ...
                            child: ClipRRect(
                              ...
                              child: Image.network(
                                StringConstants.networkImagePath +
                                    upComingResultList[index].posterPath,
                                fit: BoxFit.fill,
                              ),
                            ),
                          ),
                        ...
                        TextLabel(
                          text: upComingResultList[index].title,
                          maxLines: 1,
                          overflow: TextOverflow.visible,
